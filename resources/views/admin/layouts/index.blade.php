...
<head>
    ...
    <meta content="D Dreams Creation Pvt Ltd" name="description" />
...
<div id="wrapper">
        ...
        <div class="slimscroll-menu" id="remove-scroll">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('album.list')}}" class="waves-effect">
                            <i class="far fa-image"></i><span> Album Types</span>
                        </a>
                    </li>
                    @endrole

                    <li>
                        <a href="{{route('photo_gallery.index')}}" class="waves-effect">
                            <i class="far fa-images"></i><span> Photo Gallery </span>
                        </a>
                    </li>

                    <li>
                        <a href="{{route('video_gallery.index')}}" class="waves-effect">
                            <i class="fas fa-film"></i><span> Video Gallery </span>
                        </a>
                    </li>
    ...
    <div class="content-page">
        ...
        <footer class="footer">
            © 2020 - 2021 D Dreams Creation <span class="d-none d-sm-inline-block"> - All Rights Reserved <i class="mdi mdi-heart text-danger"></i></span>.
        </footer>
