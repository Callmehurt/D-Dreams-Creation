...
@section('content')
    ...
    <section class="home" id="home">
        <div class="home__container bd-container bd-grid">
            <div class="home__data">
                <h1 class="home__title">Dreams Creation</h1>
                <h2 class="home__subtitle">Capture moments like <br> a Dream.</h2>
                <a href="#" class="button">BOOK NOW</a>
            </div>
            <div class="home-img-wrapper" style="margin-top: 1.5rem;">
                <img src="{{asset('assets/wallpaper/camera lense circle2.png')}}" alt="" class="home__img">
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="about__container bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">We click the best <br> for you</h2>
                        <p class="about__description">At Dreams Studio, we are focused on providing Photography & Videography services with the highest levels of customer satisfaction and do everything we can to meet your expectations. With a variety of offerings to choose from, we’re sure you’ll be happy working with us.</p>
                        <a href="#" class="button">Know More</a>
                    </div>

                    <img src="assets/wallpaper/about us.jpg" alt="" class="about__img">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="project-area bd-container" id="our_works">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-md-6 col-sm-12 element-item latest">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p1.jpg">
                                <img src="./assets/img/projects/p2.jpg" alt="portfolio-1" class="img-fluid">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item popular">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p2.jpg">
                                <img src="./assets/img/projects/p2.jpg" alt="portfolio-2" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item popular">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p3.jpg">
                                <img src="./assets/img/projects/p3.jpg" alt="portfolio-3" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p4.jpg">
                                <img src="./assets/img/projects/p4.jpg" alt="portfolio-4" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p5.jpg">
                                <img src="./assets/img/projects/p5.jpg" alt="portfolio-5" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p6.jpg">
                                <img src="./assets/img/projects/p6.jpg" alt="portfolio-6" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p7.jpg">
                                <img src="./assets/img/projects/p7.jpg" alt="portfolio-7" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p8.jpg">
                                <img src="./assets/img/projects/p8.jpg" alt="portfolio-8" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                    <div class="our-project">
                        <div class="img">
                            <a class="test-popup-link" href="./assets/img/projects/p9.jpg">
                                <img src="./assets/img/projects/p9.jpg" alt="portfolio-9" class="img-fluid">
                            </a>
                        </div>
                        <div class="title py-4">
    ...
    <!--  ======================= Video gallery Area =============================  -->
    <section class="videos section bd-container" id="video_gallery">
        <div class="container">
        <span class="section-subtitle">Special</span>
        <h2 class="section-title">Explore Our Amazing Video Shoots</h2>
        <div class="button-group">
            <button type="button" class="active" id="video_filter" data-filter="*">All</button>
            <button type="button" data-filter=".popular">Popular</button>
            <button type="button" data-filter=".latest">Latest</button>
            <button type="button" data-filter=".following">Following</button>
            <button type="button" data-filter=".upcoming">Upcoming</button>
        ...
        <div class="row grid">
            <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                <div class="our-project">
                    <div class="img video_thumbnail">
                        <img src="./assets/img/projects/p9.jpg" alt="portfolio-9" class="img-fluid">
                        <a href="https://www.youtube.com/watch?v=b-jJO0ntrGU" class="magnific-youtube"><button><i class="fas fa-play"></i></button></a>
                    </div>
                    <div class="title py-4">
                        <h4 class="text-uppercase">Camera Lens</h4>
                        <span class="text-secondary">Upcoming, Portfolio</span>
